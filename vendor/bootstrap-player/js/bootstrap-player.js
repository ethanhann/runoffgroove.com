(function($) {
    ...
    $('audio[controls]').before(function(){
        ...
        $(toggle_holder).addClass('btn-group row');
        ...
        var load_error = function(){
            ...
            $(player_box).find('.fa-spin').removeClass('fa fa-spinner fa-spin');
        };
        ...
        var addSeek = function() {
            ...
            $(seek_wrapper).addClass('btn btn-default disabled col-xs-4');
        ...
        var addTime = function() {
            ...
            $(time).addClass('btn btn-default col-xs-3');
        ...
        var addVolume = function() {
            ...
            $(vol_wrapper).addClass('btn btn-default disabled col-xs-3');
